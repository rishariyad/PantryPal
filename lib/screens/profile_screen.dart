...
//           setState(() {
//             Map<String, dynamic> userPreferences = profileSnapshot.data() as Map<String, dynamic>;
...
//             _tastesController.text = userPreferences['tastes']?.join(', ') ?? '';
//             _dietaryNeedsController.text = userPreferences['dietary_needs']?.join(', ') ?? '';
//             _cuisineController.text = userPreferences['cuisine'] ?? '';
//             _preferencesController.text = userPreferences['preferences']?.join(', ') ?? '';
//             isLoading = false;
//           });
//         }
//       } catch (e) {
...
//           'dietary_needs': dietaryNeeds.split(',').map((need) => need.trim()).toList(),
//           'cuisine': cuisine,
//           'preferences': preferences.split(',').map((preference) => preference.trim()).toList(),
...
//                       decoration: InputDecoration(labelText: 'Tastes (e.g., spicy, sweet)'),
//                       enabled: _isEditing, // Editable only in edit mode
//                     ),
//                     TextField(
//                       controller: _dietaryNeedsController,
//                       decoration: InputDecoration(labelText: 'Dietary Needs (e.g., vegan, gluten-free)'),
//                       enabled: _isEditing, // Editable only in edit mode
//                     ),
//                     TextField(
//                       controller: _cuisineController,
//                       decoration: InputDecoration(labelText: 'Preferred Cuisine (e.g., Indian)'),
//                       enabled: _isEditing, // Editable only in edit mode
//                     ),
//                     TextField(
//                       controller: _preferencesController,
//                       decoration: InputDecoration(labelText: 'Preferences (e.g., weight-loss, post-surgery recovery)'),
//                       enabled: _isEditing, // Editable only in edit mode
//                     ),
